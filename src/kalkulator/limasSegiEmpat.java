 ...
 */
public class limasSegiEmpat extends javax.swing.JFrame {
    ...
    private void volumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_volumeActionPerformed
        ...
        float v = (float) ((sisi * sisi) * tinggi * 0.3);
    ...
    private void luasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_luasActionPerformed
        ...
        float luas = (float) ((sisi * sisi) + (4 * (0.5 * alas * tinggi)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(limasSegiEmpat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new limasSegiEmpat().setVisible(true);
            }
        });
    }
